 ...
 *   2. Returns <ClientsBody />. Chrome (header + LeftRail) comes from
 *      the shared layout.
 *
...
export default async function PipelineClientsPage({
  ...
  // returned data isn't needed here (ClientsBody self-fetches); the
  // call is purely for the gate's redirect safety.
  await fetchCanvasRouteBundle(slug, pipelineId);
